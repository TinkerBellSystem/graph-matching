# 1 "provenance_record.h"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "provenance_record.h" 2
# 39 "provenance_record.h"
